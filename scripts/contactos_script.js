...
function trocarEstilo() {
    ...
    if (tema.getAttribute("href") === "styles/contactos_style.css") {
        tema.setAttribute("href", "styles/contactos_style_dark.css");
        botao.textContent = "Modo Claro";

        // Salva o tema escuro no localStorage
        localStorage.setItem("tema", "dark");
    } else {
        tema.setAttribute("href", "styles/contactos_style.css");
